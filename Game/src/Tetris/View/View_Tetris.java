...
import Tetris.Model.Model_LoggerTetris;
...
public class View_Tetris extends View_AbstractWithChildren
{
    ...
    // Controller.
    protected PApplet app;//@removeLineFromPjs
    ...
    public View_Tetris(
        ...
        @removeLineFromPjs*/
        super(null, null, 10);
        this.app = start;//@removeLineFromPjs
    }
    ...
    private void initGame() throws Model_Exception {
        ...
        // fake training @removeLineFromAll
        Model_LoggerTetris logger = new Model_LoggerTetris();//@removeLineFromAll
        logger.openLogFile();//@removeLineFromAll
        this.getController().setLogger(logger);//@removeLineFromAll

        this.getController().setBaseMediaUrl("http://tetris");//@removeLineFromPjsAll
        ...
        this.getController().setGameStarted(true);//@removeLineFromAll
        this.resultsPopup = 1;
    ...
    public void startGame() throws Model_Exception {
        ...
        int[] playerTypes;
         ...
         @removeLineFromPjs*/
        int[] playerTypes = new int[]//@removeLineFromPjs
                {//@removeLineFromPjs
                        Model_Player.PLAYER_TYPE_ROBOT_GENETIC,//@removeLineFromPjs
                        Model_Player.PLAYER_TYPE_ROBOT_GENETIC,//@removeLineFromPjs
                };//@removeLineFromPjs
    ...
    public PApplet getApp() {//@removeLineFromPjs
        return app;//@removeLineFromPjs
    }//@removeLineFromPjs
